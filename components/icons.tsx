...
export const FuelIcon: React.FC<IconProps> = ({ className, size=24 }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 22h12" />
      <path d="M4 22V6.23a1 1 0 0 1 .5-1.73l6-3.46a1 1 0 0 1 1.5.87V14" />
      <path d="M18 14h1.8a.2.2 0 0 1 .2.2v6.6a.2.2 0 0 1-.2.2H16.4a.2.2 0 0 1-.2-.2V19" />
      <path d="M15 14a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v0a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1Z" />
    </svg>
);
...
export const DeerIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M2 22c0-5.5 4.5-10 10-10s10 4.5 10 10" />
        <path d="M16 18a4 4 0 0 0-8 0" />
        <path d="M2 22c0-3.5 2.5-6.5 6-7" />
        <path d="M22 22c0-3.5-2.5-6.5-6-7" />
        <path d="M7 10c0-2 1-3 3-3s3 1 3 3" />
        <path d="M7 5c0-1 .5-2 2-2s2 .5 2 2" />
        <path d="M12 2v2" />
        <path d="M9 8v2" />
        <path d="M15 8v2" />
    </svg>
