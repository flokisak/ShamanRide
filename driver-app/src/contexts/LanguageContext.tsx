  ...
  cs: {
    ...
    "dashboard": {
      ...
      "send": "Odeslat",
       ...
       "manualRide": {
         "title": "Přidat přímou jízdu",
         "destination": "Cíl",
         "waypoint": "Mezizastávka",
         "addWaypoint": "Přidat mezizastávku",
         "removeWaypoint": "Odebrat",
         "estimatedDistance": "Odhadovaná vzdálenost (km) - volitelné",
         "distanceHelp": "Volitelné - slouží pouze pro automatický výpočet ceny podle tarifů",
         "estimatedPrices": "Odhadované ceny podle tarifu (z {distance} km)",
         "economyRate": "Ekonomický tarif (36 Kč/km)",
         "standardRate": "Standardní tarif (40 Kč/km)",
         "vanRate": "Dodávka (60 Kč/km)",
         "priceAutoSet": "Cena bude automaticky nastavena podle standardního tarifu",
         "addRide": "Přidat jízdu",
         "creating": "Vytváření jízdy...",
         "success": "Jízda byla přidána!",
         "successMessage": "Přímá jízda byla úspěšně přidána a zahájena.",
         "openNavigation": "Otevřít navigaci",
         "error": "Chyba při vytváření jízdy",
