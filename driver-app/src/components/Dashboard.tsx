...
const Dashboard: React.FC = () => {
  ...
  const [vehicles, setVehicles] = useState<any[]>([]);
    ...
    const [activeCard, setActiveCard] = useState<'operations' | 'settings'>('operations');
          ...
          <div className="max-w-md mx-auto">
            <div className="flex rounded-2xl bg-slate-800/50 p-1 border border-slate-700/50">
              <button
                ...
                className={`flex-1 py-4 px-6 rounded-xl text-sm font-medium transition-all duration-200 ${
                  activeCard === 'operations'
